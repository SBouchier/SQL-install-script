...
Install-SQL2017 -SQLFilePath C:\Users\Simon\Downloads\ExpressAdv_ENU\SETUP.exe -InstallPath D:\SQL -ConfigIniPath D:\git\SQL-install-script\SQL2017Media\ConfigurationFile.ini -InstallSharedDir 'C:\Users\Simon\Downloads\SQLtest' -InstanceName 'SQLEXPRESS_898' -InstanceID 'SQLEXPRESS_898' -Features 'SQLENGINE','REPLICATION','ADVANCEDANALYTICS','SQL_INST_MR','SQL_INST_MPY','FULLTEXT','CONN','BC','SDK','LOCALDB','BROWSER','WRITER' -SQLauthentication -SQLpwd 'test'
